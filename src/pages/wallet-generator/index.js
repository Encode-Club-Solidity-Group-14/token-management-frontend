...
const WalletGenerator = () => {
  return (
    ...
    <Main>
    <FormWrapper>
        <InputComponent type={"text"} value={""} labelName={"Token Name"} label={"TokenName"} placeholder={"Encode Token"}/>
        <InputComponent type={"text"} value={""} labelName={"Token Symbol"} label={"TokenSymbol"} placeholder={"ENC"}/>
        <InputComponent type={"number"} value={""} labelName={"Token Supply"} label={"TokenSupply"} placeholder={1000}/>
    </FormWrapper>
    <ButtonGroups>
